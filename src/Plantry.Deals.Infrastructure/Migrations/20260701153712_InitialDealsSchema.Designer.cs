...
namespace Plantry.Deals.Infrastructure.Migrations
{
    ...
    [Migration("20260701153712_InitialDealsSchema")]
    partial class InitialDealsSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plantry.Deals.Domain.Deal", b =>
                {
                    b.OwnsOne("Plantry.Deals.Domain.ValidityWindow", "ValidityWindow", b1 =>
                        {
                            ...
                            b1.ToTable("deal", "deals");

                            b1.WithOwner()
                                .HasForeignKey("DealId");
                        });

                    b.Navigation("ValidityWindow")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Plantry.Deals.Domain.FlyerImport", b =>
                {
                    b.OwnsOne("Plantry.Deals.Domain.ValidityWindow", "ValidityWindow", b1 =>
                        {
                            b1.Property<Guid>("FlyerImportId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("FlyerImportId");

                            b1.ToTable("flyer_import", "deals");

                            b1.WithOwner()
                                .HasForeignKey("FlyerImportId");
                        });
