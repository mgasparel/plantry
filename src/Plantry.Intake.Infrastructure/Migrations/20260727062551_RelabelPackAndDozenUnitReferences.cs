...
namespace Plantry.Intake.Infrastructure.Migrations
{
    ...
    public partial class RelabelPackAndDozenUnitReferences : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // the full rationale. This migration relabels Intake's own soft unit_id reference (DM-3:
            ...
            migrationBuilder.Sql(dozPkCte +
                "UPDATE intake.import_line il SET unit_id = e.ea_id " +
                "FROM doz_pk d JOIN ea_units e ON e.household_id = d.household_id " +
                "WHERE il.unit_id = d.id;");
        }
