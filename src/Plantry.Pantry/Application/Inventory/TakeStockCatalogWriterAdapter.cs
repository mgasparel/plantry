...
/// <summary>
/// Adapter for <see cref="ITakeStockCatalogWriter"/> (P4-7, J5, TS-8) — an intra-context Pantry
/// collaboration now that Catalog and Inventory live in one assembly (ADR-024, plantry-g3da.6).
/// Performs the inline Catalog mutations the Take Stock walk makes, over Catalog's own commands:
/// <list type="bullet">
