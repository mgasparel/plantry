...
/// <summary>
/// Write port for the Take Stock inline-add flow (P4-7, J5, TS-8), used as an intra-context Pantry
/// collaboration now that Catalog and Inventory live in one assembly (ADR-024, plantry-g3da.6). Its
/// adapter composes <see cref="Plantry.Pantry.Application.CreateProductCommand"/> and
/// <see cref="Plantry.Pantry.Application.SetDefaultLocationCommand"/> directly.
///
