...
namespace Plantry.Market.Infrastructure.Migrations.Pricing
{
    /// <inheritdoc />
    public partial class RelabelPackAndDozenUnitReferences : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // the full rationale. This migration relabels Pricing's own soft unit_id reference (DM-3:
            ...
            migrationBuilder.Sql(dozPkCte +
                "UPDATE pricing.price_observation po SET unit_id = e.ea_id " +
                "FROM doz_pk d JOIN ea_units e ON e.household_id = d.household_id " +
                "WHERE po.unit_id = d.id;");
        }
