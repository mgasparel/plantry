...
/// these extensions — never via the <see cref="DateTimeOffset"/> property that silently reads
/// the machine's own local zone (<see cref="TimeZoneInfo"/>'s <c>Local</c>), bypassing the injected clock
/// entirely, and never by reading <see cref="TimeZoneInfo"/>'s <c>Local</c> zone directly at a call site.
/// </summary>
