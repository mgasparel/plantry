...
public sealed class ShoppingList : AggregateRoot<ShoppingListId>
{
    ...
    /// <see cref="Plantry.Planning.Application.AddItemCommand"/> to implement the
    ...
    ///
    /// The caller (<see cref="Plantry.Planning.Application.AddItemCommand"/>) is responsible for
    ...
    ///
    /// Called exclusively by <see cref="Plantry.Planning.Application.AddItemCommand"/> (plantry-9scq).
    /// </summary>
    ...
    /// preserved).
    ///
    /// <para>The caller (<see cref="Plantry.Planning.Application.SyncSourceContributionCommand"/>)
