...
/// <see cref="Plantry.Planning.Domain.ItemSource"/> enum 1:1 (TRIAGE DECISION 2026-07-03).
///
...
/// discriminator set structurally from <see cref="Plantry.Planning.Domain.ItemSource"/>, not from
