...
public sealed record DealDeckCardVm(
    ...
    string? UnitMismatchHint,
    bool HasSuggestion,
    string? SuggestedProductName,
    bool SuggestedProductIsParent,
    string? Reasoning,
    bool IsNoise,
    string ConfirmUrl,
    string RejectUrl);
        ...
        IReadOnlyList<DealReviewView> deals, string? flyerKey, string displayCurrency)
    {
        ...
        var cards = deals.Select(d =>
        {
            ...
            return new DealDeckCardVm(
                ...
                PriceBasis: DealReviewDisplay.FormatPriceBasis(d.Quantity, d.DealUnitCode),
                InventoryUnitCode: d.SuggestedProductUnitCode,
                UnitMismatchHint: DealReviewDisplay.BuildUnitMismatchHint(d),
                HasSuggestion: d.HasSuggestion,
                SuggestedProductName: d.SuggestedProductName,
                SuggestedProductIsParent: d.SuggestedProductIsParent,
