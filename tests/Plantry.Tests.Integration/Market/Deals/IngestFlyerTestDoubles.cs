...
/// <summary>
/// Stub <see cref="IPriceObservationRepository"/> for ingest tests that don't assert on the written
/// observation itself — ConfirmDeal now writes deal-sourced observations directly against this port
/// rather than through the former cross-context IPriceObservationWriter seam (ADR-024 Market merge).
/// </summary>
internal sealed class StubPriceObservationRepository : IPriceObservationRepository
{
...
internal sealed class StubUnitPriceCalculator : IUnitPriceCalculator
{
